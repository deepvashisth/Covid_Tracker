...
fig.savefig("../src/images/sentiment_images/covidSentimentImages/polarity_hist.png")
...
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
fig.savefig("../src/images/sentiment_images/covidSentimentImages/subjectivity_hist.png")
...
for i in range(len(negative_df)):
      listNegative.append(negative_df.loc[i,"tweets"])
...
for i in range(len(positive_df)):
      listPositive.append(positive_df.loc[i,"tweets"])
...
plt.tight_layout()
fig.savefig("../src/images/sentiment_images/covidSentimentImages/sentiment_value_counts", bbox_inches='tight');
...
plt.axis('off')
fig.savefig("../src/images/sentiment_images/covidSentimentImages/covidTweetsWordCloud", bbox_inches='tight');
...
get_smart_clouds(wordcloud_df).savefig("../src/images/sentiment_images/covidSentimentImages/sentiment_wordclouds.png", bbox_inches="tight")
...
plt.imshow(word_cloud, interpolation='bilinear')
plt.axis('off')
fig.savefig("../src/images/sentiment_images/covidSentimentImages/hashTagWordCloud", bbox_inches='tight');