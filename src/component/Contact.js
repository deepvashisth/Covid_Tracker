...
const Contact = () => {
  return (
    <div
      ...
      className="container-fluid main-contact"
    >
      <h5 className="section-title text-center h2 ">
        Our Hardwoking <span style={{ color: "brown" }}>Team</span>
      </h5>
            ...
            <div className="flip-card-inner">
              ...
              <div className="flip-card-back">
                <div className="flip-card-back-body">
                  <p
                    style={{ paddingTop: "2.7rem", fontWeight: "660" }}
                    className="h6 "
                  >
                    Deep Vashisith contact
                  </p>
                  <div className="mt-4 ">
                    <a href="mailto:deepvashisth7777@gmail.com">
                      mail <i className="fas fa-envelope"></i>
                    </a>
                    <br />
                    <a
                      href="https://www.linkedin.com/in/deep-vashisth-a71365154/"
                      target="_blank"
                    ...
                    <br />
                    <a
                      href="https://github.com/deepvashisth"
                      target="_blank"
                      rel="noreferrer noopener"
                    >
          ...
          <div className="flip-card ">
            <div className="flip-card-inner">
              ...
              <div className="flip-card-back">
                <div className="flip-card-back-body">
                  <p
                    style={{ paddingTop: "2.6rem", fontWeight: "660" }}
                    className="h6 "
                  >
                    Avadhesh kr singh
                  </p>
                  <div className="mt-4 ">
                    <a href="mailto:kumarsinghavadhesh51@gmail.com">
                      mail <i className="fas fa-envelope"></i>
                    </a>
                    <br />
                    <a
                      href="https://www.linkedin.com/in/avadhesh-singh-9577011a7/"
                      target="_blank"
                      rel="noreferrer noopener"
                    >
                      Linkedin <i className="fab fa-linkedin"></i>
            ...
            <div className="flip-card-inner">
              ...
              <div className="flip-card-back">
                <div className="flip-card-back-body">
                  ...
                  <div className="mt-4 ">
                    <a href="mailto:ashishrk2308@gmail.com">
                      mail <i className="fas fa-envelope"></i>
                    </a>
                    <br />
                    <a
                      href="https://www.linkedin.com/in/ashish-chauhan-9bb847175"
                      target="_blank"
                      rel="noreferrer noopener"
                    >
                      Linkedin <i className="fab fa-linkedin"></i>
                    ...
                    <br />
                    <a
                      href="https://github.com/ashishrk"
                      target="_blank"
                      rel="noreferrer noopener"
                    >
                      Github <i className="fab fa-github"></i>
              ...
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back">
                  <div className="flip-card-back-body">
                    ...
                    <div className="mt-4 ">
                      <a href="mailto:itisbabu1098@gmail.com">
                        mail <i className="fas fa-envelope"></i>
                      </a>
                      <br />
                      <a
                        href="https://www.linkedin.com/in/haribabu-t-826301211"
                        target="_blank"
                        rel="noreferrer noopener"
                      >
                        Linkedin <i className="fab fa-linkedin"></i>
