const questions = [
  {
    ...
    answerOptions: [
      ...
      {
        answerText: "A virus that causes respiratory illness",
        isCorrect: false,
      },
...

  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Through respiratory droplets in the air",
        isCorrect: true,
      },
...

  {
    ...
    answerOptions: [
      {
        answerText: "COVID-19 enters the body through the mouth, nose, eyes",
        isCorrect: false,
      },
      {
        answerText:
          "Things you touch with your hands may have active virus on them",
        isCorrect: false,
      },
      {
        answerText: "The virus is absorbed easily by the pores on the face",
        isCorrect: false,
      },
...

  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Staying at least 6 feet (2 meters) from others",
        isCorrect: false,
      },
...

  {
    ...
    answerOptions: [
      {
        answerText: "No – not everyone with COVID-19 has symptoms",
        isCorrect: true,
      },
      {
        answerText:
...

  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Older people – especially those aged 70 and above",
        isCorrect: false,
      },
      {
        answerText: "People with certain underlying health conditions",
        isCorrect: false,
      },
